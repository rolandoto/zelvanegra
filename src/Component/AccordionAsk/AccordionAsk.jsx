...
const AccordionAsk =({faqs}) =>{
    ...
    return ( <section className="flex flex-col   max-w-7xl md:flex-row container mx-auto py-12">
                <div className="md:w-1/2 px-4">
                    <h2 className="text-2xl text-orange-500 mb-6">Preguntas frecuentes</h2>
                    <div>
                        {faqs.map((faq, index) => (
                        <AccordionItem
                            key={index}
