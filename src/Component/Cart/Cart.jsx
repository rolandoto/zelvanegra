...
const Cart = () => {
    ...
    return (
        <div className="fixed z-50 cart-shadow bg-green-700  bottom-0 left-0 right-0 flex flex-col md:flex-row items-center justify-between  p-4  rounded-t-lg">
            ...
            <button onClick={PostHotelByIdHotel} className=" Button-Search w-full rounded md:w-auto ml-0 md:ml-4 px-6 py-2 font-lora bg-black text-white">
