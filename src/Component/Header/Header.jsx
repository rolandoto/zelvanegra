    ...
    return (
            <nav className=" w-full z-40 items-center fixed p-3 bg-black shadow-md">
                    ...
                    <div className=" hidden lg:block   space-x-4">
                        <a href="#" className="text-white text-[16px] font-normal  hover:text-orange-600">Inicio</a>
                        <a href="#" className="text-white text-[16px] font-normal hover:text-orange-600">Próximos eventos</a>
                        <a href="#" className="text-white  text-[16px] font-normal hover:text-orange-600">Reservas</a>
                    </div>
