...
const RoomPresentaion =() =>{
    ...
    return (  <div className="bg-[#fff5f2] py-12 px-4">
                ...
                <div className="md:w-1/2 p-4 text-">
                    <h2 className="text-3xl font-normal text-center  text-orange-600 ">Reserva tu habitación hoy mismo</h2>
                    ...
                    <button className="text-white bg-orange-500 mt-4  p-4 rounded hover:bg-orange-600">Ver habitaciones</button>
                </div>
