...
export const IconsTiHome =() =>{
    return <TiHome   color="#16813d" className="" fontSize={30}  />
}

export const IconsFaGlassMartini =() =>{
    return <FaMartiniGlassCitrus   color="#16813d" className="" fontSize={30}  />
}

export const IconsGiForkKnifeSpoon =() =>{
    return <GiForkKnifeSpoon   color="#16813d" className="" fontSize={30}  />
}


export const IconsaCar =() =>{
    return <FaCar   color="#16813d" className="" fontSize={30}  />
}



export const IconsFaSquareParking =() =>{
    return <FaSquareParking   color="#16813d" className="" fontSize={30}  />
}

export const IconsFaStore =() =>{
    return <FaStore   color="#16813d" className="" fontSize={30}  />
}

export const IconsFaBanSmoking =() =>{
    return <FaBanSmoking   color="#16813d" className="" fontSize={30}  />
}

export const IconsFaConciergeBell =() =>{
    return <FaConciergeBell   color="#16813d" className="" fontSize={30}  />
}


export const IconsRiBankFill =() =>{
    return <RiBankFill   color="#16813d" className="" fontSize={30}  />
}
