...
const ButtonAccomodation =({price,nights,person,handleAddToCart})=>{
        return (
            <ContaineButton >
                ...
                <button onClick={handleAddToCart} className="  w-full md:w-[150px]   Button-Search bg-green-700 text-white py-4  rounded hover:bg-green-700 transition duration-200">
                    Reservar 
                </button>
        </ContaineButton>
        )
